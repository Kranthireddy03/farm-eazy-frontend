        ...
        <div className={`mb-6 p-4 rounded-xl border ${otpVerified
          ...
          <div className="mt-3 flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm font-semibold bg-gradient-to-r from-green-600 to-teal-600 text-white hover:from-green-700 hover:to-teal-700 transition disabled:opacity-50"
            >
                    ...
                    <div className="text-right">
                      ...
                      {v.status === 'TRANSFER_SUCCESS' && (
                        <button
                          ...
                          className="mt-2 px-3 py-1 rounded-md text-xs font-semibold bg-primary text-primary-foreground hover:bg-primary/90 disabled:opacity-50"
                        >
