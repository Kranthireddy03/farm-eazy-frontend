...
function RegistrationSuccess() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-card px-4">
      <div className="w-full max-w-md text-center bg-muted border border-border rounded-xl shadow-lg p-8">
        ...
        <p className="text-muted-foreground mb-4">Your account has been created. Redirecting to login...</p>
      </div>
    </div>
  );
}
