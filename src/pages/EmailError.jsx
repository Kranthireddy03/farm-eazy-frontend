      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            ...
            {errorDetails.email && (
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 mb-6">
                <p className="text-gray-600 text-sm">
                  ...
                  <span className="text-gray-800">{errorDetails.email}</span>
                </p>
              </div>
            )}
            ...
            {/* Suggestions */}
            <div className="mb-8">
              <h3 className="text-gray-800 font-semibold mb-3">What you can do:</h3>
            ...
            <div className="space-y-3">
              ...
              <Link
                to="/login"
                className="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 px-6 rounded-lg transition-all duration-200"
              >
                Back to Login
              </Link>
            </div>
