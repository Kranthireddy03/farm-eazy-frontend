...
function Buying() {
  ...
  useEffect(() => {
    ...
    // Only refresh products on a genuine cross-tab location change. Ignore
    // farmEazy_lastSyncAt / farmEazy_lastActivity and unrelated writes so API
    // responses never create a cross-tab fetch loop.
  ...
  return (
    <AppPage noMotion toolbar={toolbar}>
      <PremiumHero
        ...
        actions={
          <>
            <Button variant="outline" onClick={() => navigate('/products/post')} className="gap-2">
          ...
          <>
            ...
            <SummaryPanel title="Quick actions" description="Continue your purchase journey.">
              <div className="flex flex-col gap-2">
                ...
                <Button variant="outline" onClick={() => navigate('/products/post')} className="w-full gap-2">
                  <Store className="h-4 w-4" />
                  Sell products
                </Button>
              </div>
        ...
        <div className="space-y-6">
          ...
          {loading ? (
            ...
            <EmptyState
              ...
              action={
                products.length === 0 ? (
                  <Button onClick={() => navigate('/products/post')}>List a product</Button>
                ) : (
