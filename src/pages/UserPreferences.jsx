    ...
    <AppPage title="User Preferences" description="Customize your FarmEazy experience.">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className={`ops-panel interactive-card overflow-hidden ${isDark ? 'border border-border' : 'border border-emerald-100'}`}>
            ...
            <div className="p-6 space-y-4">
              <div className={`flex items-center justify-between py-3 border-b ${isDark ? 'border-border' : 'border-border'}`}>
                <div className="flex-1">
                  <span className={`font-medium ${isDark ? 'text-white' : 'text-foreground'}`}>Change Password</span>
                  <p className={`text-sm mt-1 ${isDark ? 'text-muted-foreground' : 'text-muted-foreground'}`}>Update your account password using your current password.</p>
                </div>
                <div className="ml-4">
                  <Link
                    to="/change-password"
              ...
              <div className="flex items-center justify-between py-3">
                <div className="flex-1">
                  <span className={`font-medium ${isDark ? 'text-white' : 'text-foreground'}`}>Change Email & Phone</span>
                  <p className={`text-sm mt-1 ${isDark ? 'text-muted-foreground' : 'text-muted-foreground'}`}>Manage primary contact details with OTP verification.</p>
                </div>
                <div className="ml-4">
                  <Link
                    to="/user/contact"
