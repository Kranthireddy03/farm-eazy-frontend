...
function VendorDashboard() {
  ...
  return (
    <AppPage
      ...
      actions={(
        <>
          <Link to="/selling" className={buttonVariants({ size: 'sm' })}>Manage products</Link>
          <Link to="/irrigation-services" className={buttonVariants({ size: 'sm', variant: 'secondary' })}>
            Manage services
          </Link>
        </>
      )}
      ...
      {eligibility?.vendorDashboardEligible && !hasListings && (
        ...
        >
          <div className="flex flex-wrap gap-2">
            <Link to="/selling" className={buttonVariants({ size: 'sm' })}>Add product</Link>
            <Link to="/irrigation-services" className={buttonVariants({ size: 'sm', variant: 'outline' })}>
              Add service
            </Link>
          </div>
        </InfoPanel>
